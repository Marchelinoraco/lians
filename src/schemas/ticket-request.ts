...
/**
 * Bidang yang sama untuk form publik dan pencatatan manual — lihat alasannya
 * di src/schemas/tour-request.ts.
 */
export const bidangPermintaanTiket = {
...
export function periksaRuteDanTanggal(
  data: { origin: string; destination: string; departureDate: string; returnDate?: string },
  ctx: z.RefinementCtx,
) {
