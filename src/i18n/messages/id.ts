...
const id = {
  nav: {
    home: 'Beranda',
    vehicles: 'Rental Mobil',
    tours: 'Paket Tour',
    ticketing: 'Tiket Pesawat',
    blog: 'Blog',
    terms: 'Syarat',
  ...
  home: {
    ...
    serviceRental: 'Rental Mobil',
    serviceRentalDesc: 'Lepas kunci atau dengan sopir, harian sampai mingguan.',
    serviceFlight: 'Tiket Pesawat',
    serviceFlightDesc: 'Sebutkan rute dan tanggalnya, kami carikan penawarannya.',
    serviceTour: 'Paket Tour',
    serviceTourDesc: 'Bunaken, Likupang, dan dataran tinggi Minahasa.',
  },
  testimonials: {
