      ...
      >
        ...
        >
          ...
          {/* Menu dipusatkan secara absolut, bukan lewat flex: dengan begitu
              ...
              Jarak dan ukuran huruf dirapatkan pada rentang lg (1024–1279px):
              dengan sembilan menu, ukuran penuh membuat menu terakhir menindih
              pemilih bahasa. Di 1280px ke atas ruangnya cukup dan ukurannya
              kembali normal. */}
          <div className="absolute left-1/2 top-1/2 hidden -translate-x-1/2 -translate-y-1/2 items-center gap-0.5 lg:flex">
            {NAV_ITEMS.map((item) => (
              <Link
                ...
                className={cn(
                  'whitespace-nowrap rounded-full py-2 font-medium transition-colors',
